...
container=QSE_Approximate_wikiData_29__June-sp-25-rs-500_xmx24g

echo "About to run docker container: ${container}"

docker run -m 100GB -d --name $container -e "JAVA_TOOL_OPTIONS=-Xmx24g" --mount type=bind,source=/srv/data/iq26og/data/,target=/app/data --mount type=bind,source=/srv/data/iq26og/git/shacl/,target=/app/local $image /app/local/config/wo-max-card/wiki/wikiData-sp-25-rs-500.properties
...
echo "------------------ wikiData-sp-25-rs-5000.properties: WIKIDATA WITHOUT MAX CARDINALITY CONSTRAINTS ------------------"
### Clear Cache
echo "Clearing cache"
sync; echo 1 > /proc/sys/vm/drop_caches

container=QSE_Approximate_wikiData_29__June-sp-25-rs-5000_xmx24g

echo "About to run docker container: ${container}"

docker run -m 100GB -d --name $container -e "JAVA_TOOL_OPTIONS=-Xmx24g" --mount type=bind,source=/srv/data/iq26og/data/,target=/app/data --mount type=bind,source=/srv/data/iq26og/git/shacl/,target=/app/local $image /app/local/config/wo-max-card/wiki/wikiData-sp-25-rs-5000.properties
...
container=QSE_Approximate_wikiData_29__June-sp-50-rs-500_xmx24g

echo "About to run docker container: ${container}"

docker run -m 100GB -d --name $container -e "JAVA_TOOL_OPTIONS=-Xmx24g" --mount type=bind,source=/srv/data/iq26og/data/,target=/app/data --mount type=bind,source=/srv/data/iq26og/git/shacl/,target=/app/local $image /app/local/config/wo-max-card/wiki/wikiData-sp-50-rs-500.properties
...
echo "------------------ wikiData-sp-50-rs-5000.properties: WIKIDATA WITHOUT MAX CARDINALITY CONSTRAINTS ------------------"
### Clear Cache
echo "Clearing cache"
sync; echo 1 > /proc/sys/vm/drop_caches

container=QSE_Approximate_wikiData_29__June-sp-50-rs-5000_xmx24g

echo "About to run docker container: ${container}"

docker run -m 100GB -d --name $container -e "JAVA_TOOL_OPTIONS=-Xmx24g" --mount type=bind,source=/srv/data/iq26og/data/,target=/app/data --mount type=bind,source=/srv/data/iq26og/git/shacl/,target=/app/local $image /app/local/config/wo-max-card/wiki/wikiData-sp-50-rs-5000.properties
...
container=QSE_Approximate_wikiData_29__June-sp-75-rs-500_xmx24g

echo "About to run docker container: ${container}"

docker run -m 100GB -d --name $container -e "JAVA_TOOL_OPTIONS=-Xmx24g" --mount type=bind,source=/srv/data/iq26og/data/,target=/app/data --mount type=bind,source=/srv/data/iq26og/git/shacl/,target=/app/local $image /app/local/config/wo-max-card/wiki/wikiData-sp-75-rs-500.properties
...
echo "------------------ wikiData-sp-75-rs-5000.properties: WIKIDATA WITHOUT MAX CARDINALITY CONSTRAINTS ------------------"
### Clear Cache
echo "Clearing cache"
sync; echo 1 > /proc/sys/vm/drop_caches

container=QSE_Approximate_wikiData_29__June-sp-75-rs-5000_xmx24g

echo "About to run docker container: ${container}"

docker run -m 100GB -d --name $container -e "JAVA_TOOL_OPTIONS=-Xmx24g" --mount type=bind,source=/srv/data/iq26og/data/,target=/app/data --mount type=bind,source=/srv/data/iq26og/git/shacl/,target=/app/local $image /app/local/config/wo-max-card/wiki/wikiData-sp-75-rs-5000.properties
...
##sync; echo 1 > /proc/sys/vm/drop_caches
##
##container=QSE_Approximate_wikiData_29__June-sp-25-rs-1500
##
##echo "About to run docker container: ${container}"
##
...
#sync; echo 1 > /proc/sys/vm/drop_caches
#
#container=QSE_Approximate_wikiData_29__June-sp-75-rs-500
#
#echo "About to run docker container: ${container}"
#
...
#sync; echo 1 > /proc/sys/vm/drop_caches
#
#container=QSE_Approximate_wikiData_29__June-sp-75-rs-1000
#
#echo "About to run docker container: ${container}"
#
...
##sync; echo 1 > /proc/sys/vm/drop_caches
##
##container=QSE_Approximate_wikiData_29__June-sp-75-rs-1500
##
##echo "About to run docker container: ${container}"
##
...
#sync; echo 1 > /proc/sys/vm/drop_caches
#
#container=QSE_Approximate_wikiData_29__June-sp-50-rs-500
#
#echo "About to run docker container: ${container}"
#
...
#sync; echo 1 > /proc/sys/vm/drop_caches
#
#container=QSE_Approximate_wikiData_29__June-sp-50-rs-1000
#
#echo "About to run docker container: ${container}"
#
...
##sync; echo 1 > /proc/sys/vm/drop_caches
##
##container=QSE_Approximate_wikiData_29__June-sp-50-rs-1500
##
##echo "About to run docker container: ${container}"
##
...
##sync; echo 1 > /proc/sys/vm/drop_caches
##
##container=QSE_Approximate_wikiData_29__June-sp-100-rs-500
##
##echo "About to run docker container: ${container}"
##
...
##sync; echo 1 > /proc/sys/vm/drop_caches
##
##container=QSE_Approximate_wikiData_29__June-sp-100-rs-1000
##
##echo "About to run docker container: ${container}"
##
...
##sync; echo 1 > /proc/sys/vm/drop_caches
##
##container=QSE_Approximate_wikiData_29__June-sp-100-rs-1500
##
##echo "About to run docker container: ${container}"
##
