...
container=QSE_Approximate_wikiData_29_june_15_00-sp-10-rs-200_xmx_32g
...
container=QSE_Approximate_wikiData_29_june_15_00-sp-75-rs-5000_xmx_32g

echo "About to run docker container: ${container}"

docker run -m 100GB -d --name $container -e "JAVA_TOOL_OPTIONS=-Xmx32g" --mount type=bind,source=/srv/data/iq26og/data/,target=/app/data --mount type=bind,source=/srv/data/iq26og/git/shacl/,target=/app/local $image /app/local/config/wo-max-card/wiki/wikiData-sp-75-rs-500.properties
