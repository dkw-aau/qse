...
public class BullyReservoirSampling implements ReservoirSampling {
    Map<Integer, EntityData> entityDataMapContainer;
    Map<Integer, List<Integer>> sampledEntitiesPerClass;
    NodeEncoder nodeEncoder;
    Encoder encoder;
    
    public BullyReservoirSampling(Map<Integer, EntityData> entityDataMapContainer, Map<Integer, List<Integer>> sampledEntitiesPerClass, NodeEncoder nodeEncoder, Encoder encoder) {
