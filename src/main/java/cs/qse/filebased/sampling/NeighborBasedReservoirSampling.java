...
public class NeighborBasedReservoirSampling implements ReservoirSampling {
    ...
    public NeighborBasedReservoirSampling(Map<Integer, EntityData> entityDataMapContainer, Map<Integer, List<Integer>> sampledEntitiesPerClass, NodeEncoder nodeEncoder, Encoder encoder) {
